...
{
       0,    61,    61,    65,    66,    69,    73,    77,    80,    84,
      91,    92,    96,   113,   121,   122,   126,   131,   136,   141,
     147,   151,   159,   160,   164,   167
};
#endif
...
static const char *const yytname[] =
{
  ...
  "LESS", "GREATGREAT", "GREATAMPERSAND", "GREATGREATAMPERSAND", "PIPE",
  "AMPERSAND", "TWOGREAT", "$accept", "goal", "commands", "command",
...
{
      10,     0,    -6,    -6,     1,     9,    -6,    -6,    -6,    -6,
       3,    -6,    -6,    -6,    14,    15,    -5,    -6,    -6,    -6,
      16,    17,    18,    19,    20,    -6,    21,    -6,    22,    -6,
      -6,    -6,    -6,    -6,    -6,    -6
};
...
{
       5,     0,     7,     8,     9,    10,     6,    12,    13,     0,
       1,     1,     3,     3,    11,     6,     6,     3,     3,     3,
...
static const yytype_int8 yystos[] =
{
      ...
      23,     6,     0,    17,    20,    11,    25,     3,    21,    19,
       5,     7,     8,     9,    10,    12,    13,    24,    26,     3,
       3,     3,     3,     3,     3,     6
};
...
#line 96 "shell.y"
    ...
    char *pre = (char *)"";
    flag = false;
    expandWildcard(pre, (char *)(yyvsp[0].cpp_string)->c_str());
...
#line 136 "shell.y"
  ...
  //  printf("   Yacc: insert output \"%s\"\n", $2->c_str());
    Shell::_currentCommand._outFile = (yyvsp[0].cpp_string);
    Shell::_currentCommand._errFile = new std::string((yyvsp[0].cpp_string)->c_str());
  }
#line 1463 "y.tab.cc"
    break;
